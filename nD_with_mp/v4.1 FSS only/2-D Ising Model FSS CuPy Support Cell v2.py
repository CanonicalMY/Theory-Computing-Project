...
if __name__ == "__main__":
    ...
    lattice_size = 16  # Increase as needed
    random_init = False
    steps_MC = 313  # Number of MC sweeps; adjust for equilibration # L=64, s=5000; 128,20000; 256,80000.
    n_runs = 100  # Number of independent runs for averaging # This is important! at least 20.
